...
import { muiCourseData } from "../data/muiCourse.js"; // ← FIXED: добавлено .js

export default function JSCoursePage({ onBack }) {
  const theme = useTheme();
  const completedTopics = muiCourseData.topics.filter(topic => topic.completed).length;
  const totalTopics = muiCourseData.topics.length;
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      <Box sx={{ maxWidth: "100%", mx: "auto" }}>
        ...
        {muiCourseData.topics.map((topic) => (
